"""
Common code for unit testing of rules generated with Snakemake 7.25.0.
"""
...
class OutputChecker:
    ...
    def check(self):
        ...
        if unexpected_files:
            pass # unexpected file do not necessitate an error
            #print('AAAAAA'+"-".join(unexpected_files))
            #raise ValueError(
            #    "Unexpected files:\n{}".format(
    ...
    def compare_files(self, generated_file, expected_file):
        assert os.path.isfile(generated_file), f"File {generated_file} not found."
