...
if [[ "$mgcnt" == "0" ]]; then
    echo "Installing DAY \(which will be sourced for you when you \'source dyinit  --project <PROJECT> --region <REGION>\' \(see docs\)  you should not need to source MG directly.  Beginning install... "
    echo "..."
    sleep 1.4
...
echo "==="
echo "___"
echo 'you should log out of this shell and log back into a fresh shell, run source dyinit  --project <PROJECT> --region <REGION>, dy-a *****, etc.'
