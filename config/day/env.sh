...
if [[ $conda_dir == "" ]]; then
    echo" >>> ERROR: conda has not been found in your PATH.  If you do not have conda installed, you may run the mod installer+build command: source dyinit  --project <PROJECT> --region <REGION> && mod-activate BUILD_all"
fi
